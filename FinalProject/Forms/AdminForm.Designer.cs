namespace FinalProject
{
	partial class AdminForm
	{
		...
		private void InitializeComponent()
		{
			...
			answerPercentButton = new Button();
			...
			tableLayoutPanel1.Size = new Size(859, 527);
			tableLayoutPanel1.TabIndex = 0;
			// 
			// ContainerPanel
			// 
			ContainerPanel.Dock = DockStyle.Fill;
			ContainerPanel.Location = new Point(3, 82);
			ContainerPanel.Margin = new Padding(3, 2, 3, 2);
			ContainerPanel.Name = "ContainerPanel";
			ContainerPanel.Size = new Size(853, 443);
			...
			tableLayoutPanel3.Controls.Add(answerPercentButton, 2, 0);
			...
			tableLayoutPanel3.Size = new Size(853, 76);
			tableLayoutPanel3.TabIndex = 1;
			// 
			// createQuestionButton
			// 
			createQuestionButton.Dock = DockStyle.Fill;
			createQuestionButton.Location = new Point(713, 2);
			createQuestionButton.Margin = new Padding(3, 2, 3, 2);
			createQuestionButton.Name = "createQuestionButton";
			createQuestionButton.Size = new Size(137, 72);
			...
			createPollButton.Location = new Point(571, 2);
			createPollButton.Margin = new Padding(3, 2, 3, 2);
			createPollButton.Name = "createPollButton";
			createPollButton.Size = new Size(136, 72);
			...
			// answerPercentButton
			// 
			answerPercentButton.Dock = DockStyle.Fill;
			answerPercentButton.Location = new Point(287, 3);
			answerPercentButton.Name = "answerPercentButton";
			answerPercentButton.Size = new Size(136, 70);
			answerPercentButton.TabIndex = 3;
			answerPercentButton.Text = "درصد پاسخگویی سوالات نظرسنجی";
			answerPercentButton.UseVisualStyleBackColor = true;
			answerPercentButton.Click += answerPercentButton_Click;
			// 
			// AdminForm
			// 
		...
		private Button answerPercentButton;
	}
}